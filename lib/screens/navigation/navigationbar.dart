...
class NavigationDrawerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //print("context.watch<AuthenticationProvider>().currentUser. " + "${context.read<UserCredientials>().getUSerData()}");
    final name = context.watch<UserCredientials>().username;
